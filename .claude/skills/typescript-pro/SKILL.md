...
> **Language Note**: Please answer in **Portuguese (pt-BR)** by default, unless explicitly requested otherwise. Code variables and naming conventions should remain in **English**, but code comments can be in **Portuguese (pt-BR)**.
